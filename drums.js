  ...
  function Engine(question, reponse) {
          ...
          if (reponse != rep[question]) {
                  ...
                  if (!faite[question]) {
                          ...
                          alert("Wrong! The good answer is" + " " + rep[question] + " " );
 ...
 //final result
  ...
  function NextLevel () {
          ...
          if (score > 8 && score <= 10) {
                  ...
                  alert(score + "/10. " + "good job !");
  
                  }
  
          if (score > 6 && score <= 8) {
  
                  alert(score + "/10. " + "good, but not perfect..");
          ...
          if (score >= 4 && score < 6) {
                  ...
                  alert(score + "/10. " + "not good, an other try ?");
  
                  }
  
          if (score < 4) {
  
                  alert(score + "/10. " + "retry again !");
          }
